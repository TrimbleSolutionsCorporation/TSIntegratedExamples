namespace SpreadsheetReinforcement.Tools
{
    ...
    public static class TxLength
    {
        ...
        {
            return TxModel.IsImperial
                ? ln.ToString(LengthUnit.Foot, "1/16")
                : ln.ToString(LengthUnit.Millimeter, "0.00");
        }

        /// <summary>
        /// Uses BIM Length.Parse to convert string to Length and returns Millimeter value
        /// Uses IMPERIAL to decide if input is Foot versus millimeter value in string format
        ...
        public static double FromCurrentUnits(this string str)
        {
