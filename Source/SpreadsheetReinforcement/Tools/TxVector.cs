namespace SpreadsheetReinforcement.Tools
{
    ...
    public static class TxVector
    {
        ...
        public static bool IsSameDirection(this Vector v1, Vector v2,
            double angleTolerance = GeometryConstants.ANGULAR_EPSILON)
        {
            if (v2 == null) return false;
        ...
        public static bool IsOppositeDirection(this Vector v1, Vector v2,
            double angleTolerance = GeometryConstants.ANGULAR_EPSILON)
        {
            if (v2 == null) return false;
            var angle = v1.GetAngleBetween(v2) * 180 / Math.PI;
        ...
        public static bool IsPerpendicular(this Vector v1, Vector v2,
            double angleTolerance = GeometryConstants.ANGULAR_EPSILON)
        {
        ...
        public static Vector Multiplier(this Vector v, Matrix m)
        {
